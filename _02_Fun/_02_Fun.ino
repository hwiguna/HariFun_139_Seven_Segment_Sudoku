...
void loop() {
  DrawLetter_F();
  digitalWrite(digit0, HIGH); // Display F on digit 0
  digitalWrite(digit0, LOW);  // Almost immediately, turn off Digit 0

  DrawLetter_U();
  digitalWrite(digit1, HIGH); // Display U on digit 1
  digitalWrite(digit1, LOW);  // Almost immediately, turn off Digit 1

  DrawLetter_N();
  digitalWrite(digit2, HIGH); // Display U on digit 2
  digitalWrite(digit2, LOW);  // Almost immediately, turn off Digit 2
}
